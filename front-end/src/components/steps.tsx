...
const steps = [
  ...
  {title: "Explora el mapa",
    content: 'El mapa muestra todos los incidentes reportados. Puedes arrastrarlo con el mouse o dedo, y hacer zoom con la rueda del mouse o pellizcar.',
    image: "🗺️",
    tip: 'Usa los botones +, - y Reset para controlar el zoom'
  },
  {
    title: 'Ver Incidentes',
    content: 'Haz clic en cualquier marcador del mapa o en un incidente de la lista lateral para ver sus detalles completos.',
    image: '👀',
    tip: 'Los colores indican diferentes categorías'
  },
    {
    title: 'Filtrar Incidentes',
    content: 'Usa los filtros de categoría y estado en la barra lateral para encontrar incidentes específicos.',
    image: '🔍',
    tip: 'Combina filtros para búsquedas más precisas',
  },
  {
    title: 'Reportar un Incidente',
    content: 'Haz clic en cualquier lugar del mapa o presiona el botón + en la esquina superior de la barra lateral.',
    image: '📍',
    tip: 'La ubicación se marcará automáticamente',
  },
  {
    title: 'Completar el Formulario',
    content: 'Selecciona una categoría, escribe un título descriptivo y añade detalles del incidente. Luego presiona "Reportar".',
    image: '📝',
    tip: 'Sé específico para ayudar a resolver el problema',
  },
  {
    title: '¡Listo para Empezar!',
    content: 'Ya estás preparado para usar la aplicación. Tu reporte ayudará a mejorar la comunidad.',
    image: '✅',
